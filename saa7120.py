...
def saa7120():
  ...
  bus.write_byte_data(0x44, 0x6c, 0x01) # 0x6c,0x01, // HTRIG
  bus.write_byte_data(0x44, 0x6d, 0x30) # 0x6d,0x30, // VTRIG
  ...
  bus.write_byte_data(0x44, 0x76, 0x05) # 0x76,0x05, // TTXOVS=05 for PAL V odd start (line 5)
  bus.write_byte_data(0x44, 0x77, 0x16) # 0x77,0x16, // TTXOVE=16 for PAL V odd end (line 22)
  bus.write_byte_data(0x44, 0x78, 0x04) # 0x78,0x04, // TTXEVS=04 for PAL V even start (should be line 4) 
